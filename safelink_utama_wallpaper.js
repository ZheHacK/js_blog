...
.intro-header{text-align:center;padding:74px 0 20px;color:#f8f8f8;background:url(https://2.bp.blogspot.com/-2lYkIBS7OtQ/WFzBt6ZZ8YI/AAAAAAAAo_M/gZ050Fys7ggZk8nqpixZdNLULgYPlMv3gCLcB/s1600/city_street_night_background_wallpaper.jpg);background-repeat:no-repeat;background-size:cover;background-position:center;position:relative;}
...
var str = currentURL;
var res = str.replace("https://zhesafelink.blogspot.com?url=", "");
$(".Visit_Link").hide();
function changeLink(){
...
<header itemscope='itemscope' itemtype='https://schema.org/WPHeader'>
      <b:section class='header float-xs-left' id='header' maxwidgets='1' showaddelement='no'>
        <b:widget id='Header1' locked='true' title='Kompi Safelink V3 (Header)' type='Header' version='1'>
          <b:widget-settings>
...
<script src='https://cdn.rawgit.com/KompiAjaib/js/master/safelink_utama.js'/>
<script>
//<![CDATA[
...
<script src='https://cdn.rawgit.com/KompiAjaib/js/master/safelink.js'/>
<script>
//<![CDATA[
...
var xxx=null;
if(x=="1"){xxx="10-food-qatari-everyone-must-try.html"}
if(x=="2"){xxx="russian-banya.html"}
if(x=="3"){xxx="10-everyday-tips-to-keep-your-car-clean.html"}
if(x=="4"){xxx="the-15-things-wealthy-kids-have-in.html"}
output.value = "https://zhesafelink.blogspot.com/2020/03/"+xxx+"?url=" + Base64.encode(this.value); //change with your link
    } else {
      output.value = "";
    }
  }
